...
export type TeamsXEventType = 'teamsx/team-created' | 'teamsx/team-approved' | 'teamsx/team-halted' | 'teamsx/team-resumed' | 'teamsx/team-deleted' | 'teamsx/plan-discarded' | 'teamsx/member-added' | 'teamsx/member-removed' | 'teamsx/task-created' | 'teamsx/task-updated' | 'teamsx/message-sent';
