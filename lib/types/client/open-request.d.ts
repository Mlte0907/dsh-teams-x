 ...
 */
export declare function requestTeamsXPanel(sessionId: string | undefined): boolean;
/** Subscribe to open requests; returns the unsubscribe function. */
export declare function onTeamsXPanelRequest(listener: TeamsXPanelListener): () => void;
/** Subscribe to unclaimed fallback; returns the unsubscribe function. */
export declare function onTeamsXPanelUnclaimed(listener: TeamsXPanelUnclaimedListener): () => void;
