window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ActivityPanel_module_css_default = {
			"animCelebrate": "ccAtPW_animCelebrate",
			"animPulse": "ccAtPW_animPulse",
			"animSend": "ccAtPW_animSend",
			"animSpin": "ccAtPW_animSpin",
			"animThink": "ccAtPW_animThink",
			"badge": "ccAtPW_badge",
			...
			"dag": "ccAtPW_dag",
			"emptyLogo": "ccAtPW_emptyLogo",
			"emptyState": "ccAtPW_emptyState",
			"errorBox": "ccAtPW_errorBox",
			"inbox": "ccAtPW_inbox",
			...
			"retryButton": "ccAtPW_retryButton",
			...
			"taskDepList": "ccAtPW_taskDepList",
			"taskDepTag": "ccAtPW_taskDepTag",
			"taskIcon": "ccAtPW_taskIcon",
			"taskId": "ccAtPW_taskId",
			"taskLane": "ccAtPW_taskLane",
			"taskLaneSegment": "ccAtPW_taskLaneSegment",
			...
			"teamsx-celebrate": "ccAtPW_teamsx-celebrate",
			"teamsx-enter": "ccAtPW_teamsx-enter",
			"teamsx-pulse": "ccAtPW_teamsx-pulse",
			"teamsx-send": "ccAtPW_teamsx-send",
			"teamsx-sheet-up": "ccAtPW_teamsx-sheet-up",
			"teamsx-spin": "ccAtPW_teamsx-spin",
			"teamsx-think": "ccAtPW_teamsx-think"
		};
		//#endregion
		...
		*/
		function useIsNarrow() {
			const [isNarrow, setIsNarrow] = (0, react.useState)(() => window.matchMedia("(max-width: 720px)").matches);
			(0, react.useEffect)(() => {
		...
		*/
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [
							ActivityIcon !== void 0 && (0, react_jsx_runtime.jsx)(ActivityIcon, {
								size: 14,
								className: member.activity === "working" ? ActivityPanel_module_css_default.animPulse : member.activity === "idle" ? ActivityPanel_module_css_default.animThink : void 0,
								decorative: true
							}),
							t(stateKey),
							!readOnly && member.activity === "working" && (0, react_jsx_runtime.jsx)("button", {
								type: "button",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					task.depth > 0 && (0, react_jsx_runtime.jsx)("span", {
						className: ActivityPanel_module_css_default.taskLane,
						"aria-hidden": true,
						children: Array.from({ length: Math.min(task.depth, 4) }, (_, i) => (0, react_jsx_runtime.jsx)("span", {
							className: ActivityPanel_module_css_default.taskLaneSegment,
							"data-depth": i
						}, i))
					}),
					(0, react_jsx_runtime.jsx)("span", {
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [task.subject, task.dependencies.length > 0 && (0, react_jsx_runtime.jsx)("span", {
							className: ActivityPanel_module_css_default.taskDepList,
							children: task.dependencies.map((dep) => (0, react_jsx_runtime.jsx)("span", {
								className: ActivityPanel_module_css_default.taskDepTag,
								children: dep
							}, dep))
						})]
					}),
		...
		function TeamCard({ team, t, openMember, readOnly }) {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					team.phase === "staged" && !readOnly && (0, react_jsx_runtime.jsx)(PlanReviewBar, {
						team,
						t
					}),
					(0, react_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							!readOnly && team.phase === "running" && team.halted !== true && !confirming && (0, react_jsx_runtime.jsx)("button", {
								type: "button",
		...
		*/
		function ActivityPanel({ sessionId, t, openMember }) {
			...
			if (sessionTeams.length === 0 && !hasArchived && error === void 0) return null;
