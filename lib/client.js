window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".ccAtPW_panel{color:var(--dsh-text,#1f2328);flex-direction:column;gap:10px;padding:12px;font-size:13px;display:flex;overflow-y:auto}.ccAtPW_badgeFab{border:1px solid var(--dsh-border,#d0d7de);background:var(--dsh-bg,#fff);color:var(--dsh-accent,#5b4cf0);cursor:pointer;border-radius:999px;align-items:center;gap:6px;width:fit-content;height:fit-content;padding:6px 10px;font-size:12px;display:inline-flex;position:absolute;top:64px;right:18px;box-shadow:0 2px 8px #00000024}.ccAtPW_badgeFab:hover{border-color:var(--dsh-accent,#5b4cf0)}.ccAtPW_badgeFabCount{color:var(--dsh-text,#1f2328);font-weight:600}.ccAtPW_badgeFabBusy{background:var(--dsh-accent,#5b4cf0);color:#fff;border-radius:999px;justify-content:center;align-items:center;min-width:16px;height:16px;padding:0 4px;font-size:10px;animation:1.6s ease-in-out infinite ccAtPW_teamsx-pulse;display:inline-flex}.ccAtPW_panelWindow{border:1px solid var(--dsh-border,#d0d7de);background:var(--dsh-bg,#fff);width:400px;max-width:calc(100vw - 32px);max-height:min(72vh,640px);color:var(--dsh-text,#1f2328);border-radius:12px;flex-direction:column;gap:10px;padding:12px;font-size:13px;display:flex;position:absolute;top:104px;right:18px;overflow-y:auto;box-shadow:0 8px 28px #0000002e}.ccAtPW_panelHeader{justify-content:space-between;align-items:center;gap:8px;display:flex}.ccAtPW_panelTitle{align-items:center;gap:8px;margin:0;font-size:14px;font-weight:600;display:flex}.ccAtPW_refreshButton{border:1px solid var(--dsh-border,#d0d7de);color:inherit;cursor:pointer;background:0 0;border-radius:6px;width:26px;height:26px}.ccAtPW_refreshButton:hover{background:var(--dsh-hover,#7d7d7d1f)}.ccAtPW_panelEmpty{color:var(--dsh-text-muted,#656d76);text-align:center;padding:18px 8px}.ccAtPW_panelError{color:#cf222e;padding:8px}.ccAtPW_teamList{flex-direction:column;gap:12px;display:flex}.ccAtPW_teamCard{border:1px solid var(--dsh-border,#d0d7de);background:var(--dsh-bg,#fff);border-radius:10px;flex-direction:column;gap:8px;padding:10px;display:flex}.ccAtPW_teamCard[data-halted]{opacity:.75}.ccAtPW_teamHeader{flex-wrap:wrap;align-items:flex-start;gap:8px;display:flex}.ccAtPW_teamLogo{color:var(--dsh-accent,#5b4cf0);flex-shrink:0;margin-top:2px}.ccAtPW_teamTitleBlock{flex:auto;min-width:0}.ccAtPW_teamName{margin:0;font-size:13px;font-weight:600}.ccAtPW_teamGoal{color:var(--dsh-text-muted,#656d76);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:2px 0 0;display:-webkit-box;overflow:hidden}.ccAtPW_teamBadges{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.ccAtPW_badge,.ccAtPW_badgeMuted,.ccAtPW_badgeWarn{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px}.ccAtPW_badge{background:color-mix(in srgb, var(--dsh-accent,#5b4cf0) 14%, transparent);color:var(--dsh-accent,#5b4cf0)}.ccAtPW_badgeMuted{background:var(--dsh-hover,#7d7d7d1f);color:var(--dsh-text-muted,#656d76)}.ccAtPW_badgeWarn{color:#9a6700;background:#d4a72c38}.ccAtPW_stopButton{color:#cf222e;cursor:pointer;background:0 0;border:1px solid #cf222e66;border-radius:6px;align-self:center;padding:2px 10px;font-size:12px}.ccAtPW_stopButton:hover{background:#cf222e1a}.ccAtPW_stopConfirmBox{border:1px solid #cf222e59;border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;display:flex}.ccAtPW_stopConfirmBox p{margin:0}.ccAtPW_stopError{color:#cf222e}.ccAtPW_stopActions{justify-content:flex-end;gap:8px;display:flex}.ccAtPW_stopCancel,.ccAtPW_stopConfirm{cursor:pointer;border-radius:6px;padding:2px 10px;font-size:12px}.ccAtPW_stopCancel{border:1px solid var(--dsh-border,#d0d7de);color:inherit;background:0 0}.ccAtPW_stopConfirm{color:#fff;background:#cf222e;border:none}.ccAtPW_roster{flex-direction:column;gap:2px;display:flex}.ccAtPW_memberRow{border-radius:6px;grid-template-columns:22px minmax(72px,1.2fr) minmax(0,1.6fr) auto auto minmax(96px,auto);align-items:center;gap:6px;padding:3px 4px;display:grid}.ccAtPW_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsh-accent,#5b4cf0) 7%, transparent)}.ccAtPW_memberIcon{color:var(--dsh-accent,#5b4cf0);display:inline-flex}.ccAtPW_memberName{text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.ccAtPW_memberMeta{color:var(--dsh-text-muted,#656d76);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}.ccAtPW_memberProgress{font-variant-numeric:tabular-nums;color:var(--dsh-text-muted,#656d76);font-size:11px}.ccAtPW_memberUnread{color:#fff;background:#cf222e;border-radius:999px;justify-content:center;align-items:center;min-width:16px;height:16px;padding:0 4px;font-size:10px;display:inline-flex}.ccAtPW_memberState{color:var(--dsh-text-muted,#656d76);align-items:center;gap:4px;font-size:11px;display:inline-flex}.ccAtPW_dag{flex-direction:column;gap:2px;display:flex}.ccAtPW_taskRow{border:1px solid #0000;border-radius:6px;grid-template-columns:18px 34px minmax(0,1fr) auto auto;align-items:center;gap:6px;padding:3px 4px;display:grid}.ccAtPW_taskRow[data-state=running]{border-color:color-mix(in srgb, var(--dsh-accent,#5b4cf0) 35%, transparent)}.ccAtPW_taskRow[data-state=failed]{background:#cf222e14}.ccAtPW_taskIcon{display:inline-flex}.ccAtPW_taskRow[data-state=completed] .ccAtPW_taskIcon{color:#1a7f37}.ccAtPW_taskRow[data-state=failed] .ccAtPW_taskIcon{color:#cf222e}.ccAtPW_taskRow[data-state=running] .ccAtPW_taskIcon{color:var(--dsh-accent,#5b4cf0)}.ccAtPW_taskRow[data-state=blocked] .ccAtPW_taskIcon{color:#9a6700}.ccAtPW_taskId{font-family:var(--dsh-mono,ui-monospace, monospace);color:var(--dsh-text-muted,#656d76);font-size:11px}.ccAtPW_taskSubject{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.ccAtPW_taskAssignee{color:var(--dsh-text-muted,#656d76);font-size:11px}.ccAtPW_taskStatus{white-space:nowrap;font-size:11px}.ccAtPW_inbox{border-top:1px dashed var(--dsh-border,#d0d7de);padding-top:6px}.ccAtPW_inboxTitle{text-transform:uppercase;letter-spacing:.04em;color:var(--dsh-text-muted,#656d76);margin:0 0 4px;font-size:11px;font-weight:600}.ccAtPW_inboxEmpty{color:var(--dsh-text-muted,#656d76);margin:0;font-size:12px}.ccAtPW_inboxList{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.ccAtPW_inboxItem{gap:6px;font-size:12px;display:flex}.ccAtPW_inboxFrom{flex-shrink:0;font-weight:600}.ccAtPW_inboxContent{color:var(--dsh-text-muted,#656d76);-webkit-line-clamp:2;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.ccAtPW_animPulse{transform-origin:50%;animation:1.6s ease-in-out infinite ccAtPW_teamsx-pulse}@keyframes ccAtPW_teamsx-pulse{0%,to{opacity:1;transform:scale(1)}50%{opacity:.55;transform:scale(.92)}}.ccAtPW_animSpin{animation:1.2s linear infinite ccAtPW_teamsx-spin;display:inline-block}@keyframes ccAtPW_teamsx-spin{to{transform:rotate(360deg)}}";
		...
		*/
		function useAvoidCover(surfaceRef) {
			const [shift, setShift] = (0, react.useState)(18);
			(0, react.useEffect)(() => {
				const CANDIDATES = [
					18,
					60,
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsx)("span", {
						...
						children: RoleIcon !== void 0 ? (0, react_jsx_runtime.jsx)(RoleIcon, { size: 18 }) : (0, react_jsx_runtime.jsx)(TeamsXLogo, {
							size: 18,
							label: member.name
						})
					}),
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [ActivityIcon !== void 0 && (0, react_jsx_runtime.jsx)(ActivityIcon, {
							size: 14,
		...
		function ActivityPanel({ t }) {
			...
			const workingCount = teams.filter((team) => team.halted !== true).reduce((count, team) => count + team.members.filter((member) => member.activity === "working").length, 0);
			if (!expanded) {
				if (teams.length === 0 && error === void 0) return null;
				return (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						(0, react_jsx_runtime.jsx)(TeamsXLogo, { size: 16 }),
						(0, react_jsx_runtime.jsx)("span", {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("header", {
						...
						children: [
							(0, react_jsx_runtime.jsxs)("h2", {
								...
								children: [
									(0, react_jsx_runtime.jsx)(TeamsXLogo, { size: 18 }),
									" ",
					...
					error === void 0 && teams.length === 0 && (0, react_jsx_runtime.jsx)("p", {
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: teams.map((team) => (0, react_jsx_runtime.jsx)(TeamCard, {
							team,
							t: translate
		...
		*/
		...
		function apply(ctx) {
			...
			const Panel = ({ t }) => (0, react_jsx_runtime.jsx)(ActivityPanel, { t });
