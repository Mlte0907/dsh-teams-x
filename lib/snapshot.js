...
import { CAPTAIN_KEY, listArchivedTeamIds, readArchivedTeam, readTeam, readMailbox, readUnreadMailbox, taskDepthsById, taskVisualState, readTeamOperations, } from "./state.js";
import { TERMINAL_TASK_STATUSES } from "./types.js";
import { readTokenUsage } from "./compat.js";
...
export async function assembleTeamSnapshot(ctx, stateRoot, workspace, state, options = {}) {
    ...
    const mailboxResults = await Promise.allSettled(roster.map(async (member) => {
