...
function IconSvg({ body, label, size = 16, className, decorative }) {
    return (_jsx("svg", { viewBox: '0 0 24 24', width: size, height: size, fill: 'none', stroke: 'currentColor', strokeWidth: ICON_STROKE.width, strokeLinecap: ICON_STROKE.linecap, strokeLinejoin: ICON_STROKE.linejoin, className: className, role: decorative === true ? undefined : 'img', "aria-hidden": decorative === true || undefined, "aria-label": decorative === true ? undefined : label, children: _jsx("g", { dangerouslySetInnerHTML: { __html: body } }) }));
}
